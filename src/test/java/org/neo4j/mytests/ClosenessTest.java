...
public class ClosenessTest {
    ...
    @Test
    public void shouldReturnCloseness() {
        ...
        try{
            String q1 = serverBaseUri + "hintplugin/centralities/flowcloseness/0";
            String q2 = serverBaseUri + "hintplugin/centralities/flowcloseness/1";
            String q3 = serverBaseUri + "hintplugin/centralities/flowcloseness/2";
            String q4 = serverBaseUri + "hintplugin/centralities/flowcloseness/3";
            String q5 = serverBaseUri + "hintplugin/centralities/flowcloseness/4";
        ...
        for(int i =0; i<uriArray.length; i++){
            try {
                ...
                System.out.println("*********closeness-json: " + obj.optDouble("flow-closeness"));
            } catch(Exception ex) {
                System.out.println("ClosenessTest Exception: " + ex);
            }
        }
